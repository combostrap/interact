...
import {getMarkdownConfig} from "../../node/markdown/conf/markdownConfig.ts";
import type {markdownFormat} from "../../node/config/configSchema.ts";
...
async function markdownReactProcessing(vFileCompatible: Compatible, options?: markdownOptions) {
    ...
    const vFile: VFileType = await unified()
...
import {rehypeUpdateRootTagName} from "../../node/markdown/plugins/rehypeUpdateRootTagName.ts";
